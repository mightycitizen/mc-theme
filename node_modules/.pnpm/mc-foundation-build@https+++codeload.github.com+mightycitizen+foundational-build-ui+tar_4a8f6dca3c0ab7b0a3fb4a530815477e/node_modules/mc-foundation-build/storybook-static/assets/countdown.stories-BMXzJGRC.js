import{t as d,T as u}from"./twig-BXd3Gfe2.js";import{D as l,a as c}from"./twig-foVUGi9y.js";import"./_commonjsHelpers-BosuxZz1.js";c(u);u.cache(!1);const o=t=>t,m=(t={})=>{const a=d.twig({id:"/Users/jabelmunoz/Documents/projects/foundational-build-drupal/web/themes/custom/mc_theme/storybook/src/stories/components/informational/countdown/countdown.twig",data:[{type:"raw",value:`<div x-data="{
...
`,position:{start:1370,end:1370}}],precompiled:!0});a.options.allowInlineIncludes=!0;try{let e=t.defaultAttributes?t.defaultAttributes:[];return Array.isArray(e)||(e=Object.entries(e)),o(a.render({attributes:new l(e),...t}))}catch(e){return o("An error occurred whilst rendering /Users/jabelmunoz/Documents/projects/foundational-build-drupal/web/themes/custom/mc_theme/storybook/src/stories/components/informational/countdown/countdown.twig: "+e.toString())}},x={title:"Components/Informational/Countdown"},y=t=>m(t),s=new Date;s.setMonth(s.getMonth()+1);s.setHours(s.getDate()+1);const w=s.getTime(),g={date:w},n=y.bind({});n.args=g;var i,r,p;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`args => {
  // You can either use a function to create DOM elements or use a plain html string!
  // return \`<div>\${label}</div>\`;
  return twig(args);
}`,...(p=(r=n.parameters)==null?void 0:r.docs)==null?void 0:p.source}}};const b=["Countdown"];export{n as Countdown,b as __namedExportsOrder,x as default};
