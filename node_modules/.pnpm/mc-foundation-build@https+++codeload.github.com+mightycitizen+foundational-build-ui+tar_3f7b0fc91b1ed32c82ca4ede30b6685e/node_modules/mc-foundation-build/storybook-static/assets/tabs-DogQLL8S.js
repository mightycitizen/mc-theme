import{t as s,T as o}from"./twig-BXd3Gfe2.js";import{D as i,a as p}from"./twig-foVUGi9y.js";p(o);o.cache(!1);const a=e=>e,l=(e={})=>{const n=s.twig({id:"/Users/jabelmunoz/Documents/projects/foundational-build-drupal/web/themes/custom/mc_theme/storybook/src/stories/components/containers/tabs/tabs.twig",data:[{type:"raw",value:`<div x-data="{ 
    expanded: 0,
...
`,position:{start:2887,end:2887}}],precompiled:!0});n.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),a(n.render({attributes:new i(t),...e}))}catch(t){return a("An error occurred whilst rendering /Users/jabelmunoz/Documents/projects/foundational-build-drupal/web/themes/custom/mc_theme/storybook/src/stories/components/containers/tabs/tabs.twig: "+t.toString())}};export{l as t};
