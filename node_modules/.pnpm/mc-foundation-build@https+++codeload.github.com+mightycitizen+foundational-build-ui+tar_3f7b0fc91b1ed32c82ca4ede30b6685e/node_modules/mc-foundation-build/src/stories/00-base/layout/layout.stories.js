...
const NarrowTwigTemplate = (args) => {
  // You can either use a function to create DOM elements or use a plain html string!
  // return `<div>${label}</div>`;
  return narrowTwig(args);
};

const NarrowerTwigTemplate = (args) => {
  // You can either use a function to create DOM elements or use a plain html string!
  // return `<div>${label}</div>`;
  return narrowerTwig(args);
};

const SidebarTwigTemplate = (args) => {
  // You can either use a function to create DOM elements or use a plain html string!
  // return `<div>${label}</div>`;
  return sidebarTwig(args);
};
