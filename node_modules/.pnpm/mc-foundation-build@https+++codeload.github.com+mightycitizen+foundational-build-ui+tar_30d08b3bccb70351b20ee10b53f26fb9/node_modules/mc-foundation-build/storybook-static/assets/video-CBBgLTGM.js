import{t as i,T as s}from"./twig-BXd3Gfe2.js";import{D as r,a as o}from"./twig-foVUGi9y.js";import"./loader-BnDbBP6a.js";o(s);s.cache(!1);i.twig({id:"@components/utils/loader/loader.twig",data:[{type:"raw",value:`<div class="loader inline-block relative w-20 h-20">
...
`,position:{start:0,end:0}}],precompiled:!0});const a=e=>e,y=(e={})=>{const n=i.twig({id:"/Users/jabelmunoz/Documents/projects/foundational-build-drupal/web/themes/custom/mc_theme/storybook/src/stories/components/embed/video/video.twig",data:[{type:"raw",value:`<figure class="mb-0" x-data="{
	    loading: true,
	    playing: false,
	    player: null,
	    firstPlay: true,
...
`,position:{start:6037,end:6037}}],precompiled:!0});n.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),a(n.render({attributes:new r(t),...e}))}catch(t){return a("An error occurred whilst rendering /Users/jabelmunoz/Documents/projects/foundational-build-drupal/web/themes/custom/mc_theme/storybook/src/stories/components/embed/video/video.twig: "+t.toString())}};export{y as t};
